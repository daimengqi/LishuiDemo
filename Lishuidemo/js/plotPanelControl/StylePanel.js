 ...
 */
     ...
     * @example
     */
    var StylePanel = function(options) {
        var _self = this;
        this._div = options.div;
        this._scene = options.scene;
        this._plottingEdit = options.plottingEdit;
        this._plotting = options.plotting;
    ...
    StylePanel.prototype.collectionTextPropertyGridRows = function(graphicObject) {
        ...
        if (34 == this._selectedFeature.symbolType) {
            textContentObj.value = this._selectedFeature._symbolAlgo.textContent;
        } else {
